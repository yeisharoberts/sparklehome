...
function Manage_Schedule() {
    ...
    //get
    useEffect(() => {
        Axios.get('http://100.27.20.250/get_all_schedules').then((res) => {
            if (res.data) {
                console.log(res);
    ...
    const addSchedule = (newSchedule) => {
        ...
        Axios.post(`http://100.27.20.250/add_schedule`, newSchedule)
            .then((res) => {
    ...
    const updateSchedule = (scheduleId, updatedScheduleData) => {
        ...
        Axios.put(`http://100.27.20.250/update_schedule/${scheduleId}`, updatedScheduleData)
            .then((res) => {
                setToastMessage(res.data.message);
                setShowToast(true);
            })
    ...
    const deleteSchedule = (scheduleId) => {
        Axios.delete(`http://100.27.20.250/delete_schedule/${scheduleId}`)
            .then((res) => {
                setToastMessage(res.data.message);
